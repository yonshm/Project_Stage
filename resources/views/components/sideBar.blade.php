    ...
    <ul class="nav-list">
      ...
      <li>
        <a href="#">
          ...
          <span class="links_name">Bon de payement</span>
        </a>
        <span class="tooltip">Bon de payement</span>
    </li>
      <li class="dropdown">
          <a href="#" class="dropdown-btn">
              <i class='bx bx-file'></i>
              <span class="links_name">Bons de Retour</span>
            </a>
        <div class="dropdown-content">
          <a href="#">Liste bons de retour</a>
          <a href="#">Ajouter bon de retour</a>
        </div>
        <span class="tooltip">Bons et retour</span>
      </li>
